...
//    uart_reset();
    ...
    testjig_timer = T0_500ms;
    while((ADC_get_val(ADC_5v_test) < P5_5v_test_min) && (ADC_get_val(ADC_5v_test) > P5_5v_test_max)&&(ADC_get_val(ADC_12v_test) < P2_12v_test_min) && (ADC_get_val(ADC_12v_test) > P2_12v_test_max) && (get_30v_current() < 50) && testjig_timer);
    if((ADC_get_val(ADC_5v_test) < P5_5v_test_min))
